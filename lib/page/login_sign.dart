      ...
      Row(children: [
        ...
        NeumorphicButton(
          ...
          child: Container(
            ...
            width: 25,
            height: 25,
            child: Image.asset('assets/LogSign/Google_logo.png', scale: 0.8,),
          ),
        ...
        NeumorphicButton(
          ...
          child: Container(
            ...
            width: 25,
            height: 25,
            child: Image.asset('assets/LogSign/logos_facebook.png', scale: 0.8,),
          ),
        ), const Spacer(flex: 2,),
      ],),  const Spacer(),
      /// Name ///
          ...
          child: Container(
            ...
            Container(
              ...
              child: RichText(
                maxLines: 4,
                text: TextSpan(
                 style: TextStyle(fontSize: 16, color: Color.fromRGBO(179, 179, 179, 1), fontFamily: 'Nunito'),
                  children: [
